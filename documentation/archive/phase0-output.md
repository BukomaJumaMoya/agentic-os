...
| OpenClaw | ✅ OPERATIONAL | v2026.9.1, gateway on 127.0.0.1:18789, Telegram bot `<bot-id-redacted>:***` allowlisted to <chat-id-redacted>, model `openrouter/upstage/solar-pro4`, session-memory hook enabled |
| Hermes | ✅ OPERATIONAL | Running behind OpenClaw, Solar Pro4 via Nous Portal OAuth, Telegram bot `<bot-id-redacted>:***` allowlisted to <chat-id-redacted>, tools: web_search/web_extract/browser_exec/delegation/skills |
...
| Telegram integrations | ✅ OPERATIONAL | Two bots operational: Hermes (<bot-id-redacted>:***) and OpenClaw (<bot-id-redacted>:***). Both allowlisted to user <chat-id-redacted>. |
