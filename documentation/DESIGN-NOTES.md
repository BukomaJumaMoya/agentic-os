...
The long-form build narrative, kept because the reasoning is the part that is
expensive to reconstruct: what was found, what was tried, what was wrong, and
why each boundary is shaped the way it is.

This was the README until 2026-09-23. The README is now a product front page;
everything below is what it grew out of, and it is still accurate — where it
disagrees with `../README.md`, the README is newer.
